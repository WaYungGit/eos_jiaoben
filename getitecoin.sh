...
cleos -u $api push action itecointoken transfer '["wayunggogogo", "'$1'", "2.0000 ITECOIN"]' -p wayunggogogo

cleos -u $api push action itecointoken transfer '["'$1'", "itehappydice", "2.0000 ITECOIN", "bet big itedeveloper wayunggogogo"]' -p $1
